...
** Author: Becky Chao
** Date: 3/18/18
** Description: This is the header file for the Washing Room class and creates
...
#ifndef FINAL_WASHINGROOM_HPP
#define FINAL_WASHINGROOM_HPP

class WashingRoom : public Space {
public:
    WashingRoom();
